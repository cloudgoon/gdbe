...
import com.google.gdbe.client.widgets.ExplorerTree;
import com.google.gdbe.client.widgets.ExplorerTree.StarHandler;
...
public class FileListDialog extends Dialog {
  ...
  /**
   * Displays a tree view of the user's documents.
   */
  ...
  /**
   * Displays the quick view of the user's starred documents.
   */
  private void showQuickView() {
    ...
    for (DocumentServiceEntry entry : entries) {
      ...
      if (entry.getFolders().length > 0) {
        ...
        folderLabel.setStylePrimaryName("gdbe-Explorer-Document-Folder");
